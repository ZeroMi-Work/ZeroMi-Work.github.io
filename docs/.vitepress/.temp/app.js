...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"ZeroMi Studio","description":"共携手，赴所爱","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"首页","link":"/"},{"text":"官网","link":"https://www.zeromi.cn/"}],"sidebar":[{"text":"关于我们","collapsible":true,"collapsed":false,"items":[{"text":"关于我们","link":"/About-Us"},{"text":"Github","link":"https://github.com/ZeroMi-Studio/"},{"text":"Gitee","link":"https://gitee.com/zermi"}]},{"text":"BiliIns","collapsible":true,"collapsed":true,"items":[{"text":"开始使用","link":"/BiliIns/"},{"text":"配置文件","link":"/BiliIns/Setting"},{"text":"AI对接","collapsible":true,"items":[{"text":"Ollama","link":"/BiliIns/AI-Api/Ollama"},{"text":"DeepSeek","link":"/BiliIns/AI-Api/DeepSeek"}]},{"text":"帮助与答疑","link":"/BiliIns/Q&A"},{"text":"开发文档","link":"/BiliIns/Dev-Guide"}]},{"text":"RedstoneCode Studio","collapsible":true,"collapsed":true,"items":[{"text":"项目概览","link":"/RCStudio/"},{"text":"帮助与答疑","link":"/RCStudio/Q&A"}]}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
